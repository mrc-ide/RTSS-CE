...
HPC_processing <- function(x # index of HPC run to read in and process
  ...
  output <- readRDS(paste0("M:/Hillary/RTSS-CE/03_output/HPC/casestudy_", format(x, scientific = FALSE), ".rds"))
  ...
  output$file <- paste0("M:/Hillary/RTSS-CE/03_output/HPC/casestudy_", x, ".rds")
